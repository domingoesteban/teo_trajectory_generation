function varargout = trajectory_generationANTERIOR(varargin)
% TRAJECTORY_GENERATIONANTERIOR MATLAB code for trajectory_generationANTERIOR.fig
%      TRAJECTORY_GENERATIONANTERIOR, by itself, creates a new TRAJECTORY_GENERATIONANTERIOR or raises the existing
%      singleton*.
%
%      H = TRAJECTORY_GENERATIONANTERIOR returns the handle to a new TRAJECTORY_GENERATIONANTERIOR or the handle to
%      the existing singleton*.
%
%      TRAJECTORY_GENERATIONANTERIOR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRAJECTORY_GENERATIONANTERIOR.M with the given input arguments.
%
%      TRAJECTORY_GENERATIONANTERIOR('Property','Value',...) creates a new TRAJECTORY_GENERATIONANTERIOR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before trajectory_generationANTERIOR_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to trajectory_generationANTERIOR_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help trajectory_generationANTERIOR

% Last Modified by GUIDE v2.5 20-Nov-2013 22:01:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @trajectory_generationANTERIOR_OpeningFcn, ...
                   'gui_OutputFcn',  @trajectory_generationANTERIOR_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before trajectory_generationANTERIOR is made visible.
function trajectory_generationANTERIOR_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to trajectory_generationANTERIOR (see VARARGIN)
...
% Choose default command line output for trajectory_generationANTERIOR
...
% UIWAIT makes trajectory_generationANTERIOR wait for user response (see UIRESUME)
% uiwait(handles.figureTrajectoryGeneration);


% --- Outputs from this function are returned to the command line.
function varargout = trajectory_generationANTERIOR_OutputFcn(hObject, eventdata, handles) 
