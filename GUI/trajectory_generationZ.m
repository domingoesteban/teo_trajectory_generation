function varargout = trajectory_generationZ(varargin)
% TRAJECTORY_GENERATIONZ MATLAB code for trajectory_generationZ.fig
%      TRAJECTORY_GENERATIONZ, by itself, creates a new TRAJECTORY_GENERATIONZ or raises the existing
%      singleton*.
%
%      H = TRAJECTORY_GENERATIONZ returns the handle to a new TRAJECTORY_GENERATIONZ or the handle to
%      the existing singleton*.
%
%      TRAJECTORY_GENERATIONZ('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRAJECTORY_GENERATIONZ.M with the given input arguments.
%
%      TRAJECTORY_GENERATIONZ('Property','Value',...) creates a new TRAJECTORY_GENERATIONZ or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before trajectory_generationZ_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to trajectory_generationZ_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help trajectory_generationZ

% Last Modified by GUIDE v2.5 22-Nov-2013 19:17:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @trajectory_generationZ_OpeningFcn, ...
                   'gui_OutputFcn',  @trajectory_generationZ_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before trajectory_generationZ is made visible.
function trajectory_generationZ_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to trajectory_generationZ (see VARARGIN)
...
% Choose default command line output for trajectory_generationZ
...
% UIWAIT makes trajectory_generationZ wait for user response (see UIRESUME)
% uiwait(handles.figureTrajectoryGeneration);


% --- Outputs from this function are returned to the command line.
function varargout = trajectory_generationZ_OutputFcn(hObject, eventdata, handles) 
