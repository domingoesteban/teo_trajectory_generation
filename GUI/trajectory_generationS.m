function varargout = trajectory_generationS(varargin)
% TRAJECTORY_GENERATIONS MATLAB code for trajectory_generationS.fig
%      TRAJECTORY_GENERATIONS, by itself, creates a new TRAJECTORY_GENERATIONS or raises the existing
%      singleton*.
%
%      H = TRAJECTORY_GENERATIONS returns the handle to a new TRAJECTORY_GENERATIONS or the handle to
%      the existing singleton*.
%
%      TRAJECTORY_GENERATIONS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRAJECTORY_GENERATIONS.M with the given input arguments.
%
%      TRAJECTORY_GENERATIONS('Property','Value',...) creates a new TRAJECTORY_GENERATIONS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before trajectory_generationS_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to trajectory_generationS_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help trajectory_generationS

% Last Modified by GUIDE v2.5 22-Nov-2013 19:42:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @trajectory_generationS_OpeningFcn, ...
                   'gui_OutputFcn',  @trajectory_generationS_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before trajectory_generationS is made visible.
function trajectory_generationS_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to trajectory_generationS (see VARARGIN)
...
% Choose default command line output for trajectory_generationS
...
% UIWAIT makes trajectory_generationS wait for user response (see UIRESUME)
% uiwait(handles.figureTrajectoryGeneration);


% --- Outputs from this function are returned to the command line.
function varargout = trajectory_generationS_OutputFcn(hObject, eventdata, handles) 
