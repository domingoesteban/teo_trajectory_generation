function varargout = trajectory_generationC(varargin)
% TRAJECTORY_GENERATIONC MATLAB code for trajectory_generationC.fig
%      TRAJECTORY_GENERATIONC, by itself, creates a new TRAJECTORY_GENERATIONC or raises the existing
%      singleton*.
%
%      H = TRAJECTORY_GENERATIONC returns the handle to a new TRAJECTORY_GENERATIONC or the handle to
%      the existing singleton*.
%
%      TRAJECTORY_GENERATIONC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRAJECTORY_GENERATIONC.M with the given input arguments.
%
%      TRAJECTORY_GENERATIONC('Property','Value',...) creates a new TRAJECTORY_GENERATIONC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before trajectory_generationC_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to trajectory_generationC_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help trajectory_generationC

% Last Modified by GUIDE v2.5 23-Nov-2013 16:13:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @trajectory_generationC_OpeningFcn, ...
                   'gui_OutputFcn',  @trajectory_generationC_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before trajectory_generationC is made visible.
function trajectory_generationC_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to trajectory_generationC (see VARARGIN)
...
% Choose default command line output for trajectory_generationC
...
set([handles.data_panel handles.operational_panel handles.save_operational_button handles.gen_joint_button],'Visible','off');
...
% UIWAIT makes trajectory_generationC wait for user response (see UIRESUME)
% uiwait(handles.figureTrajectoryGeneration);


% --- Outputs from this function are returned to the command line.
function varargout = trajectory_generationC_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in gen_operational_button.
...
% hObject    handle to gen_operational_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
set([handles.save_operational_button handles.joint_traj_panel handles.traj_name_panel handles.gen_joint_button handles.axis_movement_pushbutton],'Visible','on');
set(handles.save_joint_button,'Visible','off')
gen_traj_graphs_function(hObject,handles,trajectory,d_trajectory,dd_trajectory)

guidata(hObject,handles)

% --- Executes on button press in save_operational_button.
...
% --- Executes on button press in gen_joint_button.
function gen_joint_button_Callback(hObject, eventdata, handles)
% hObject    handle to gen_joint_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% current = getappdata(handles.figureTrajectoryGeneration,'Current');
...
set([handles.save_joint_button handles.humanoid_movement_pushbutton],'Visible','on');
...
set([handles.operational_panel handles.save_operational_button handles.gen_joint_button],'Visible','on');
...
% --- Executes on button press in save_joint_button.
...
% --- Executes on button press in axis_movement_pushbutton.
...
% --- Executes on button press in humanoid_movement_pushbutton.
function humanoid_movement_pushbutton_Callback(hObject, eventdata, handles)
...
% --- Executes on button press in right_leg_plot_button.
function right_leg_plot_button_Callback(hObject, eventdata, handles)
% hObject    handle to right_leg_plot_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in left_leg_plot_button.
function left_leg_plot_button_Callback(hObject, eventdata, handles)
% hObject    handle to left_leg_plot_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in torso_plot_button.
function torso_plot_button_Callback(hObject, eventdata, handles)
% hObject    handle to torso_plot_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in right_arm_plot_button.
function right_arm_plot_button_Callback(hObject, eventdata, handles)
% hObject    handle to right_arm_plot_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in left_arm_plot_button.
function left_arm_plot_button_Callback(hObject, eventdata, handles)
% hObject    handle to left_arm_plot_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
