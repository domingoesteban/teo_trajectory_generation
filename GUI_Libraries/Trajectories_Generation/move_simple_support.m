function [trajectory, d_trajectory, dd_trajectory] = move_simple_support (delta_com, delta_FF, Ts, T, trajectory, d_trajectory, dd_trajectory, leg,interpolaCoM,interpolaFF)
